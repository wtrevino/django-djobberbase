...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'JobStat.job'
        db.alter_column('djobberbase_jobstat', 'job_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['djobberbase.Job'], null=True, on_delete=models.SET_NULL))

    def backwards(self, orm):

        # Changing field 'JobStat.job'
        db.alter_column('djobberbase_jobstat', 'job_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['djobberbase.Job']))
