...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Job.category'
        db.alter_column('djobberbase_job', 'category_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['djobberbase.Category'], null=True, on_delete=models.SET_NULL))

        # Changing field 'Job.jobtype'
        db.alter_column('djobberbase_job', 'jobtype_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['djobberbase.Type'], null=True, on_delete=models.SET_NULL))

    def backwards(self, orm):

        # Changing field 'Job.category'
        db.alter_column('djobberbase_job', 'category_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['djobberbase.Category']))

        # Changing field 'Job.jobtype'
        db.alter_column('djobberbase_job', 'jobtype_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['djobberbase.Type']))
    ...
    models = {
        ...
        'djobberbase.job': {
            ...
            'category': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': "orm['djobberbase.Category']", 'null': 'True', 'on_delete': 'models.SET_NULL'}),
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'jobtype': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': "orm['djobberbase.Type']", 'null': 'True', 'on_delete': 'models.SET_NULL'}),
