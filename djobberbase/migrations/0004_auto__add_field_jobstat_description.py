...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'JobStat.description'
        db.add_column('djobberbase_jobstat', 'description',
                      self.gf('django.db.models.fields.CharField')(max_length=250, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'JobStat.description'
        db.delete_column('djobberbase_jobstat', 'description')
